...
int main(int argc, char **argv) {
  ...
  //DeleteTests
  ofstream output_streamDT("C:\\Users\\danil\\CLionProjects\\semester-work-red-black-tree\\dataset\\data\\deleteTests.csv");
  for (int i = 0; i < 14; ++i) {
    for (int j = 0; j < 10; ++j) {
  ...
  //insertTests
  ofstream output_streamIT("C:\\Users\\danil\\CLionProjects\\semester-work-red-black-tree\\dataset\\data\\insertTests.csv");
  for (int i = 0; i < 14; ++i) {
    for (int j = 0; j < 10; ++j) {
      string path = "C:\\Users\\danil\\CLionProjects\\semester-work-red-black-tree\\dataset\\data\\add\\";
      path += strDir[j];
  ...
  //searchTests
  ofstream output_streamST("C:\\Users\\danil\\CLionProjects\\semester-work-red-black-tree\\dataset\\data\\searchTests.csv");
  for (int i = 0; i < 14; ++i) {
    for (int j = 0; j < 10; ++j) {
      string path = "C:\\Users\\danil\\CLionProjects\\semester-work-red-black-tree\\dataset\\data\\add\\";
      path += strDir[j];
